 ...
 */
 ...
 // my changes: added sensorUsing, serialreads 
 ...
 */
  ...
  float temp =  alpha*tempRead + (1-alpha)*temp; //[celcius]
  ...
  sonarPast = sonarValue;
  if (sonarDist>254) { sonarDist = 254; }
  if (sonarDist<6)   { sonarDist = 6;   }
  ...
  switch (sensorUsing) {
    ...
    case 1:
      ...
      break;
    case 2:
      motorInput = sonarValue;
      break;
    case 3:
      motorInput = tempValue;
      break;
    default:
      motorInput = potValue;
    break;
 ...
 */
  ...
  //***** Move DC motor *****//
  if(motorUsing==2 || motorUsing==3){ //velocity control
